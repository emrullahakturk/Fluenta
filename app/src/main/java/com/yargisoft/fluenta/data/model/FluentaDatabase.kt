...
@Database(entities = [Quote::class, OxfordWord::class,MostCommonWord::class, CommonPhrase::class,Favorite::class,Story::class], version = 1, exportSchema = false)
